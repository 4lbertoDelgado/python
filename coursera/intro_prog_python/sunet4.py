...
def obtener_sexo() :
    sexo = input("Favor especifica tu sexo. ")
    return sexo

def obtener_pais_origen() :
...
def mostrar_perfil(nombre, edad, estatura_m, estatura_cm, sexo, pais_origen, num_amigos):
    print("--------------------------------------------------")
    print("Nombre:      ", nombre)
...
sexo = obtener_sexo()
pais_origen = obtener_pais_origen()
num_amigos = obtener_num_amigos()
print("Muy bien,", nombre, ". Entonces podemos crear un perfil con estos datos.")
mostrar_perfil(nombre, edad, estatura_m, estatura_cm, sexo, pais_origen, num_amigos)
