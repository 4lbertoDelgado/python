...
while continuar:
    modificar_nombre = str(input("Deseas modificar tu nombre? (S/N) "))

    if modificar_nombre == "S" or modificar_nombre == "s" or modificar_nombre == "":
        nombre = str(input("Ingresa tu nuevo nombre"))
        print()
        print("Muy bien,", nombre, ". Entonces podemos crear un perfil con estos datos.")
        print("--------------------------------------------------")
        print("Nombre:  ", nombre)
