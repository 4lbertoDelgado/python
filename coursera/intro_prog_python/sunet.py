...
#Cuarta interacciÃ³n. Solicitamos el sexo.
sexo = input("Cual es tu sexo? M o F ")
print()
#Quinta interacciÃ³n. Solicitamos el telefono.
telefono = input("Cual es tu numero de telefono? ")
print()
#Sexta interacciÃ³n. Solicitamos el Ciudad donde vives.
ciudad = input("Cual es el nombre de cuidad donde vives ")
print()
#Septima interacciÃ³n. Solicitamos el pais de nacimiento.
pais = input("En que pais naciste ")
print()



#Octava interacciÃ³n. Consultamos cuÃ¡ntos amigos tiene el usuario.
